...
public class TestOp implements com.otk.jesb.operation.Operation{
	...
	public TestOp(java.lang.String param2, int param3, Param4Structure param4, Param5Structure param5, Param6Structure param6, Param7Structure param7, com.otk.jesb.resource.builtin.JDBCConnection param8){
		this.param2=param2;
		this.param3=param3;
		this.param4=param4;
		this.param5=param5;
	...
	public class Builder implements com.otk.jesb.operation.OperationBuilder<TestOp>{
		...
		private com.otk.jesb.Variant<java.lang.Integer> param3Variant=new com.otk.jesb.Variant<java.lang.Integer>(java.lang.Integer.class, 123);
		private com.otk.jesb.instantiation.RootInstanceBuilder param4DynamicBuilder=new com.otk.jesb.instantiation.RootInstanceBuilder("param4Input", Param4Structure.class.getName());
		private com.otk.jesb.instantiation.RootInstanceBuilder param5DynamicBuilder=new com.otk.jesb.instantiation.RootInstanceBuilder("param5Input", new Param5InputClassNameAccessor());
		private Param6Structure.GroupBuilder param6GroupBuilder=new Param6Structure.GroupBuilder();
		private com.otk.jesb.Variant<Param7Structure> param7Variant=new com.otk.jesb.Variant<Param7Structure>(Param7Structure.class, Param7Structure.ITEM1);
		private com.otk.jesb.Reference<com.otk.jesb.resource.builtin.JDBCConnection> param8Reference=new com.otk.jesb.Reference<com.otk.jesb.resource.builtin.JDBCConnection>(com.otk.jesb.resource.builtin.JDBCConnection.class);
		public Builder(){
		...
		public void setParam8Reference(com.otk.jesb.Reference<com.otk.jesb.resource.builtin.JDBCConnection> param8Reference) {
		...
		@Override
		public void validate(boolean recursively, com.otk.jesb.solution.Plan currentPlan, com.otk.jesb.solution.Step currentStep) throws com.otk.jesb.ValidationError{
			if (recursively) {
				try {
					param3Variant.validate();
				} catch (com.otk.jesb.ValidationError e) {
					throw new com.otk.jesb.ValidationError("Failed to validate 'Param 3'", e);
				}
			}
			if (recursively) {
				try {
					...
					throw new com.otk.jesb.ValidationError("Failed to validate 'Param 4'", e);
				}
			}
			if (recursively) {
				try {
					...
					throw new com.otk.jesb.ValidationError("Failed to validate 'Param 5'", e);
				}
			}
			if (recursively) {
			try {
			...
			throw new com.otk.jesb.ValidationError("Failed to validate 'Param 6'", e);
			}
			}
			if (param8Reference.resolve() == null) {
			throw new com.otk.jesb.ValidationError("Failed to resolve the 'Param 8' reference");
			}
		}
		public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
			/* com.otk2.TestOp.Builder form customization */
			{
				/* field control positions */
				xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("param2", "param3Variant", "param4DynamicBuilder", "param5DynamicBuilder", "param6GroupBuilder", "param7Variant", "param8Reference"));
				/* param2 control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param2").setCustomFieldCaption("Param 2");
					xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param2").getSpecificTypeCustomizations(), java.lang.String.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
						private static final long serialVersionUID = 1L;
						{
							xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginIdentifier(this, "xy.reflect.ui.control.swing.plugin.StyledTextPlugin");
							xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginConfiguration(this, "xy.reflect.ui.control.swing.plugin.StyledTextPlugin", (java.io.Serializable) com.otk.jesb.PluginBuilder.readControlPluginConfiguration("<xy.reflect.ui.control.swing.plugin.StyledTextPlugin_-StyledTextConfiguration><fontName>Serif</fontName><fontBold>true</fontBold><fontItalic>true</fontItalic><fontSize>20</fontSize><horizontalAlignment>LEFT</horizontalAlignment><underlined>false</underlined><struckThrough>false</struckThrough><width/></xy.reflect.ui.control.swing.plugin.StyledTextPlugin_-StyledTextConfiguration>"));
						}
					});
				}
				/* param3Variant control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param3Variant").setCustomFieldCaption("Param 3");
					xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.GUI.VariantCustomizations.getAdapterTypeName(com.otk2.TestOp.Builder.class.getName(),"param3Variant"), com.otk.jesb.ui.GUI.VariantCustomizations.getConstantValueFieldName("param3Variant")).getSpecificTypeCustomizations(), java.lang.Integer.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
						private static final long serialVersionUID = 1L;
						{
							xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginIdentifier(this, "xy.reflect.ui.control.swing.plugin.SliderPlugin");
							xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginConfiguration(this, "xy.reflect.ui.control.swing.plugin.SliderPlugin", (java.io.Serializable) com.otk.jesb.PluginBuilder.readControlPluginConfiguration("<xy.reflect.ui.control.swing.plugin.SliderPlugin_-SliderConfiguration><maximum>200</maximum><minimum>0</minimum><paintTicks>true</paintTicks><paintLabels>true</paintLabels><minorTickSpacing>1</minorTickSpacing><majorTickSpacing>10</majorTickSpacing></xy.reflect.ui.control.swing.plugin.SliderPlugin_-SliderConfiguration>"));
						}
					});
				}
				/* param4DynamicBuilder control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param4DynamicBuilder").setCustomFieldCaption("Param 4");
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param4DynamicBuilder").setFormControlEmbeddingForced(true);
				}
				/* param5DynamicBuilder control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param5DynamicBuilder").setCustomFieldCaption("Param 5");
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param5DynamicBuilder").setFormControlEmbeddingForced(true);
				}
				/* param6GroupBuilder control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param6GroupBuilder").setCustomFieldCaption("Param 6");
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param6GroupBuilder").setValueValidityDetectionForced(true);
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param6GroupBuilder").setNullValueDistinctForced(true);
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param6GroupBuilder").setFormControlEmbeddingForced(true);
					Param6Structure.GroupBuilder.customizeUI(infoCustomizations);
				}
				/* param7Variant control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param7Variant").setCustomFieldCaption("Param 7");
				}
				/* param8Reference control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param8Reference").setCustomFieldCaption("Param 8");
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), "param8Reference").setFormControlEmbeddingForced(true);
				}
				/* hide UI customization method */
				xy.reflect.ui.info.custom.InfoCustomizations.getMethodCustomization(infoCustomizations, com.otk2.TestOp.Builder.class.getName(), xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName()))).setHidden(true);
			}
		}
	...
	public static class Metadata implements com.otk.jesb.operation.OperationMetadata<TestOp>{
		...
		public xy.reflect.ui.info.ResourcePath getOperationIconImagePath() {
			return new xy.reflect.ui.info.ResourcePath(xy.reflect.ui.info.ResourcePath.specifyClassPathResourceLocation(TestOp.class.getName().replace(".", "/") + ".png"));
		}
	}
	...
	static public class Param6Structure{
		...
		public Param6Structure(java.lang.Byte subParam1, com.otk.jesb.meta.Date subParam2, Param6StructureSubParam3Structure subParam3, Param6StructureSubParam4Structure subParam4){
		...
		static 
		public class GroupBuilder implements com.otk.jesb.operation.OperationStructureBuilder<Param6Structure>{
			private java.lang.Byte subParam1;
			private com.otk.jesb.Variant<com.otk.jesb.meta.Date> subParam2Variant=new com.otk.jesb.Variant<com.otk.jesb.meta.Date>(com.otk.jesb.meta.Date.class);
			private com.otk.jesb.instantiation.RootInstanceBuilder subParam3DynamicBuilder=new com.otk.jesb.instantiation.RootInstanceBuilder("subParam3Input", Param6StructureSubParam3Structure.class.getName());
			...
			public void setSubParam3DynamicBuilder(com.otk.jesb.instantiation.RootInstanceBuilder subParam3DynamicBuilder) {
			...
			public void validate(boolean recursively, com.otk.jesb.solution.Plan currentPlan, com.otk.jesb.solution.Step currentStep) throws com.otk.jesb.ValidationError{
				if (recursively) {
					try {
						...
						throw new com.otk.jesb.ValidationError("Failed to validate 'Sub Param 2'", e);
					}
				}
				if (recursively) {
					try {
						...
						throw new com.otk.jesb.ValidationError("Failed to validate 'Sub Param 3'", e);
					}
				}
				if (recursively) {
				try {
				...
				throw new com.otk.jesb.ValidationError("Failed to validate 'Sub Param 4'", e);
				}
				}
			}
			public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
				...
				{
					/* field control positions */
					xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("subParam1", "subParam2Variant", "subParam3DynamicBuilder", "subParam4GroupBuilder"));
					/* subParam1 control customization */
					{
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam1").setCustomFieldCaption("Sub Param 1");
					}
					/* subParam2Variant control customization */
					{
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam2Variant").setCustomFieldCaption("Sub Param 2");
					}
					/* subParam3DynamicBuilder control customization */
					{
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam3DynamicBuilder").setCustomFieldCaption("Sub Param 3");
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam3DynamicBuilder").setFormControlEmbeddingForced(true);
					}
					/* subParam4GroupBuilder control customization */
					{
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam4GroupBuilder").setCustomFieldCaption("Sub Param 4");
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam4GroupBuilder").setValueValidityDetectionForced(true);
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam4GroupBuilder").setFormControlEmbeddingForced(true);
						Param6StructureSubParam4Structure.GroupBuilder.customizeUI(infoCustomizations);
					}
					/* hide UI customization method */
					xy.reflect.ui.info.custom.InfoCustomizations.getMethodCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName()))).setHidden(true);
				}
			}
		...
		static public class Param6StructureSubParam4Structure{
			...
			static 
			public class GroupBuilder implements com.otk.jesb.operation.OperationStructureBuilder<Param6StructureSubParam4Structure>{
				...
				public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
					...
					{
						/* field control positions */
						xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, Param6StructureSubParam4Structure.GroupBuilder.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("subSubParam1", "subSubParam2"));
						/* subSubParam1 control customization */
						{
							xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6StructureSubParam4Structure.GroupBuilder.class.getName(), "subSubParam1").setCustomFieldCaption("Sub Sub Param 1");
						}
						/* subSubParam2 control customization */
						{
							xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6StructureSubParam4Structure.GroupBuilder.class.getName(), "subSubParam2").setCustomFieldCaption("Sub Sub Param 2");
						}
						/* hide UI customization method */
						xy.reflect.ui.info.custom.InfoCustomizations.getMethodCustomization(infoCustomizations, Param6StructureSubParam4Structure.GroupBuilder.class.getName(), xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName()))).setHidden(true);
					}
				}
