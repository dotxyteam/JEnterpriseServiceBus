...
/* com.otk5.TestOp.Builder form customization */
{
/* field control positions */
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("param2", "param3", "param4", "param5", "param6", "param7", "param8"));
/* param2 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param2").setCustomFieldCaption("Param 2");
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param2").getSpecificTypeCustomizations(), java.lang.String.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
...
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param3").setCustomFieldCaption("Param 3");
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.JESBReflectionUI.VariantCustomizations.getAdapterTypeName(com.otk5.TestOp.Builder.class.getName(),"param3Variant"), com.otk.jesb.ui.JESBReflectionUI.VariantCustomizations.getConstantValueFieldName("param3Variant")).getSpecificTypeCustomizations(), java.lang.Integer.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
private static final long serialVersionUID = 1L;
{
...
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param4").setCustomFieldCaption("Param 4");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param4DynamicBuilder").setFormControlEmbeddingForced(true);
}
/* param5 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param5").setCustomFieldCaption("Param 5");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param5DynamicBuilder").setFormControlEmbeddingForced(true);
}
/* param6 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param6").setCustomFieldCaption("Param 6");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param6GroupBuilder").setNullValueDistinctForced(true);
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param6GroupBuilder").setFormControlEmbeddingForced(true);
Param6Structure.GroupBuilder.customizeUI(infoCustomizations);
}
/* param7 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param7").setCustomFieldCaption("Param 7");
}
/* param8 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param8").setCustomFieldCaption("Param 8");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), "param8Reference").setFormControlEmbeddingForced(true);
}
/* hide UI customization method */
xy.reflect.ui.info.custom.InfoCustomizations.getMethodCustomization(infoCustomizations, com.otk5.TestOp.Builder.class.getName(), xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName()))).setHidden(true);
}
}
...
static public class GroupBuilder implements com.otk.jesb.operation.OperationStructureBuilder<Param6Structure>{
...
{
/* field control positions */
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("subParam1", "subParam2", "subParam3", "subParam4"));
...
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam2").setCustomFieldCaption("Sub Param 2");
}
/* subParam3 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam3").setCustomFieldCaption("Sub Param 3");
...
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(), "subParam4").setCustomFieldCaption("Sub Param 4");
...
static public class GroupBuilder implements com.otk.jesb.operation.OperationStructureBuilder<Param6StructureSubParam4Structure>{
