...
public class MyResource extends com.otk.jesb.resource.Resource {
	...
	private com.otk.jesb.Variant<java.lang.Integer> prop2Variant = new com.otk.jesb.Variant<java.lang.Integer>(
			java.lang.Integer.class, -1);
	...
	public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
		/* com.otk5.MyResource form customization */
		{
			/* field control positions */
			xy.reflect.ui.info.custom.InfoCustomizations
					.getTypeCustomization(infoCustomizations, com.otk5.MyResource.class.getName())
					.setCustomFieldsOrder(java.util.Arrays.asList("prop1", "prop2", "prop3"));
			/* prop1 control customization */
			{
				xy.reflect.ui.info.custom.InfoCustomizations
						.getFieldCustomization(infoCustomizations, com.otk5.MyResource.class.getName(), "prop1")
						.setCustomFieldCaption("1st Property");
			}
			/* prop2 control customization */
			{
				xy.reflect.ui.info.custom.InfoCustomizations
						.getFieldCustomization(infoCustomizations, com.otk5.MyResource.class.getName(), "prop2")
				...
				xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
						com.otk.jesb.ui.JESBReflectionUI.VariantCustomizations
								.getAdapterTypeName(com.otk5.MyResource.class.getName(), "prop2Variant"),
						com.otk.jesb.ui.JESBReflectionUI.VariantCustomizations
								.getConstantValueFieldName("prop2Variant"))
						...
						.getTypeCustomization(xy.reflect.ui.info.custom.InfoCustomizations
								.getFieldCustomization(infoCustomizations,
										com.otk.jesb.ui.JESBReflectionUI.VariantCustomizations.getAdapterTypeName(
												com.otk5.MyResource.class.getName(), "prop2Variant"),
										com.otk.jesb.ui.JESBReflectionUI.VariantCustomizations
												.getConstantValueFieldName("prop2Variant"))
						...
						.setSpecificProperties(new java.util.HashMap<String, Object>() {
							private static final long serialVersionUID = 1L;
							{
								xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginIdentifier(this,
										"xy.reflect.ui.control.swing.plugin.SpinnerPlugin");
								xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginConfiguration(this,
										...
										(java.io.Serializable) com.otk.jesb.PluginBuilder
												.readControlPluginConfiguration(
														"<xy.reflect.ui.control.swing.plugin.SpinnerPlugin_-SpinnerConfiguration><minimum>-100</minimum><maximum>100</maximum><stepSize>1</stepSize></xy.reflect.ui.control.swing.plugin.SpinnerPlugin_-SpinnerConfiguration>"));
							}
						});
			}
			...
			{
				xy.reflect.ui.info.custom.InfoCustomizations
						.getFieldCustomization(infoCustomizations, com.otk5.MyResource.class.getName(), "prop3")
			...
			xy.reflect.ui.info.custom.InfoCustomizations
					.getMethodCustomization(infoCustomizations, com.otk5.MyResource.class.getName(),
	...
	public static class Metadata implements com.otk.jesb.resource.ResourceMetadata {
		...
		public xy.reflect.ui.info.ResourcePath getResourceIconImagePath() {
			return new xy.reflect.ui.info.ResourcePath(xy.reflect.ui.info.ResourcePath
					.specifyClassPathResourceLocation(MyResource.class.getName().replace(".", "/") + ".png"));
		}
	}

	static public class Prop3Structure implements com.otk.jesb.resource.ResourceStructure {
		...
		public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
			/* Prop3Structure form customization */
			{
				/* field control positions */
				xy.reflect.ui.info.custom.InfoCustomizations
						.getTypeCustomization(infoCustomizations, Prop3Structure.class.getName())
						.setCustomFieldsOrder(java.util.Arrays.asList("subProp1", "subProp2"));
				/* subProp1 control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations
							.getFieldCustomization(infoCustomizations, Prop3Structure.class.getName(), "subProp1")
				...
				/* hide UI customization method */
				xy.reflect.ui.info.custom.InfoCustomizations
						.getMethodCustomization(infoCustomizations, Prop3Structure.class.getName(),
								xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI",
										java.util.Arrays
												.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName())))
						.setHidden(true);
