...
public class Schedule extends com.otk.jesb.activation.Activator {
	...
	public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
		/* com.otk4.Schedule form customization */
		{
			/* field control positions */
			xy.reflect.ui.info.custom.InfoCustomizations
					.getTypeCustomization(infoCustomizations, com.otk4.Schedule.class.getName()).setCustomFieldsOrder(
							java.util.Arrays.asList("moment", "repeating", "repetitionSettings", "reference"));
			/* moment control customization */
			{
				xy.reflect.ui.info.custom.InfoCustomizations
						.getFieldCustomization(infoCustomizations, com.otk4.Schedule.class.getName(), "moment")
						.setCustomFieldCaption("moment");
			}
			/* repeating control customization */
			{
				xy.reflect.ui.info.custom.InfoCustomizations
						.getFieldCustomization(infoCustomizations, com.otk4.Schedule.class.getName(), "repeating")
			...
			/* repetitionSettings control customization */
			{
				xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
						com.otk4.Schedule.class.getName(), "repetitionSettings")
						.setCustomFieldCaption("Repetition Settings");
				xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
						com.otk4.Schedule.class.getName(), "repetitionSettings").setFormControlEmbeddingForced(true);
				RepetitionSettingsStructure.customizeUI(infoCustomizations);
			}
			/* reference control customization */
			{
				xy.reflect.ui.info.custom.InfoCustomizations
						.getFieldCustomization(infoCustomizations, com.otk4.Schedule.class.getName(), "reference")
						.setCustomFieldCaption("Referennce");
				xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
						com.otk4.Schedule.class.getName(), "referenceReference").setFormControlEmbeddingForced(true);
			}
			/* hide UI customization method */
			xy.reflect.ui.info.custom.InfoCustomizations
					.getMethodCustomization(infoCustomizations, com.otk4.Schedule.class.getName(),
