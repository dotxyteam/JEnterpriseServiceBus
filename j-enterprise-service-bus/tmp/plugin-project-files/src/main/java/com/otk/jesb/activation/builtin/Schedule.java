...
public class Schedule extends Activator{
	...
	public static void customizeUI(InfoCustomizations infoCustomizations) {
		// com.otk.jesb.activation.builtin.Schedule form customization
		{
			...
			// startDateTimeVariant control customization
			{
				...
				InfoCustomizations.getTypeCustomization(InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.GUI.VariantCustomizations.getAdapterTypeName(com.otk.jesb.activation.builtin.Schedule.class.getName(),"startDateTimeVariant"), com.otk.jesb.ui.GUI.VariantCustomizations.getConstantValueFieldName("startDateTimeVariant"))
			...
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.activation.builtin.Schedule.class.getName(), "repeatingVariant")
				.setCustomFieldCaption("Repeat");
			}
			// repetitionSettings control customization
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.activation.builtin.Schedule.class.getName(), "repetitionSettings")
	...
	static public class RepetitionSettingsStructure implements ActivatorStructure{
		...
		private Variant<com.otk.jesb.meta.DateTime> endDateTimeVariant=new Variant<com.otk.jesb.meta.DateTime>(com.otk.jesb.meta.DateTime.class, null);
		...
		public static void customizeUI(InfoCustomizations infoCustomizations) {
			// RepetitionSettingsStructure form customization
			{
				...
				.setCustomFieldsOrder(java.util.Arrays.asList("periodUnitVariant", "periodLengthVariant", "endDateTimeVariant"));
