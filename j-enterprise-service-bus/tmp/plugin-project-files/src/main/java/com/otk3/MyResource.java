...
public class MyResource extends Resource{
	...
	public static void customizeUI(InfoCustomizations infoCustomizations) {
		// com.otk3.MyResource form customization
		{
			// field control positions
			InfoCustomizations.getTypeCustomization(infoCustomizations, com.otk3.MyResource.class.getName())
			.setCustomFieldsOrder(java.util.Arrays.asList("prop1", "prop2Variant", "prop3"));
			// prop1 control customization
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.MyResource.class.getName(), "prop1")
				.setCustomFieldCaption("1st Property");
			}
			// prop2Variant control customization
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.MyResource.class.getName(), "prop2Variant")
				.setCustomFieldCaption("2nd Property");
				InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.GUI.VariantCustomizations.getAdapterTypeName(com.otk3.MyResource.class.getName(),"prop2Variant"), com.otk.jesb.ui.GUI.VariantCustomizations.getConstantValueFieldName("prop2Variant"))
				.setNullValueDistinctForced(true);
				InfoCustomizations.getTypeCustomization(InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.GUI.VariantCustomizations.getAdapterTypeName(com.otk3.MyResource.class.getName(),"prop2Variant"), com.otk.jesb.ui.GUI.VariantCustomizations.getConstantValueFieldName("prop2Variant"))
				.getSpecificTypeCustomizations(), Integer.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
					private static final long serialVersionUID = 1L;
					{
						...
						ReflectionUIUtils.setFieldControlPluginConfiguration(this, "xy.reflect.ui.control.swing.plugin.SpinnerPlugin", (java.io.Serializable) com.otk.jesb.PluginBuilder.readControlPluginConfiguration("<xy.reflect.ui.control.swing.plugin.SpinnerPlugin_-SpinnerConfiguration><minimum>-100</minimum><maximum>100</maximum><stepSize>1</stepSize></xy.reflect.ui.control.swing.plugin.SpinnerPlugin_-SpinnerConfiguration>"));
					}
				});
			}
			// prop3 control customization
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.MyResource.class.getName(), "prop3")
			...
			InfoCustomizations.getMethodCustomization(infoCustomizations, com.otk3.MyResource.class.getName(), ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(InfoCustomizations.class.getName())))
			.setHidden(true);
		}
	}
