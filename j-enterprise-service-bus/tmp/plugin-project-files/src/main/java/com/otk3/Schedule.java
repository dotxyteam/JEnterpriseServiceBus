...
public class Schedule extends Activator{
	...
	public static void customizeUI(InfoCustomizations infoCustomizations) {
		// Schedule form customization
		{
			...
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, Schedule.class.getName(), "startVariant")
				.setCustomFieldCaption("Start At");
				InfoCustomizations.getTypeCustomization(InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.GUI.VariantCustomizations.getAdapterTypeName(Schedule.class.getName(),"startVariant"), com.otk.jesb.ui.GUI.VariantCustomizations.getConstantValueFieldName("startVariant"))
			...
			{
				InfoCustomizations.getFieldCustomization(infoCustomizations, Schedule.class.getName(), "referenceReference")
				.setCustomFieldCaption("Referennce");
				InfoCustomizations.getFieldCustomization(infoCustomizations, Schedule.class.getName(), "referenceReference")
				.setFormControlEmbeddingForced(true);
			}
			// hide UI customization method
			InfoCustomizations.getMethodCustomization(infoCustomizations, Schedule.class.getName(), ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(InfoCustomizations.class.getName())))
			.setHidden(true);
		}
	}
