...
public class TestOp implements Operation{
	...
	static public class Builder implements OperationBuilder<TestOp>{
		...
		@Override
		public TestOp build(Plan.ExecutionContext context, Plan.ExecutionInspector executionInspector) throws Exception {
		...
		@Override
		public void validate(boolean recursively, Plan currentPlan, Step currentStep) throws ValidationError{
			if (recursively) {
				try {
		...
		public static void customizeUI(InfoCustomizations infoCustomizations) {
			// TestOp.Builder form customization
			{
				// field control positions
				InfoCustomizations.getTypeCustomization(infoCustomizations, TestOp.Builder.class.getName())
				...
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param2")
					.setCustomFieldCaption("Param 2");
					InfoCustomizations.getTypeCustomization(InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param2")
					.getSpecificTypeCustomizations(), String.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
						private static final long serialVersionUID = 1L;
						{
							...
							ReflectionUIUtils.setFieldControlPluginConfiguration(this, "xy.reflect.ui.control.swing.plugin.StyledTextPlugin", (Serializable) com.otk.jesb.PluginBuilder.readControlPluginConfiguration("<xy.reflect.ui.control.swing.plugin.StyledTextPlugin_-StyledTextConfiguration><fontName>Serif</fontName><fontBold>true</fontBold><fontItalic>true</fontItalic><fontSize>20</fontSize><horizontalAlignment>LEFT</horizontalAlignment><underlined>false</underlined><struckThrough>false</struckThrough><width/></xy.reflect.ui.control.swing.plugin.StyledTextPlugin_-StyledTextConfiguration>"));
						}
					});
				}
				// param3Variant control customization
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param3Variant")
					.setCustomFieldCaption("Param 3");
					InfoCustomizations.getTypeCustomization(InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk.jesb.ui.GUI.VariantCustomizations.getAdapterTypeName(TestOp.Builder.class.getName(),"param3Variant"), com.otk.jesb.ui.GUI.VariantCustomizations.getConstantValueFieldName("param3Variant"))
					.getSpecificTypeCustomizations(), Integer.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
						private static final long serialVersionUID = 1L;
						{
							...
							ReflectionUIUtils.setFieldControlPluginConfiguration(this, "xy.reflect.ui.control.swing.plugin.SliderPlugin", (Serializable) com.otk.jesb.PluginBuilder.readControlPluginConfiguration("<xy.reflect.ui.control.swing.plugin.SliderPlugin_-SliderConfiguration><maximum>200</maximum><minimum>0</minimum><paintTicks>true</paintTicks><paintLabels>true</paintLabels><minorTickSpacing>1</minorTickSpacing><majorTickSpacing>10</majorTickSpacing></xy.reflect.ui.control.swing.plugin.SliderPlugin_-SliderConfiguration>"));
						}
					});
				}
				// param4DynamicBuilder control customization
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param4DynamicBuilder")
				...
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param5DynamicBuilder")
				...
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param6GroupBuilder")
				...
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param7Variant")
					.setCustomFieldCaption("Param 7");
				}
				// param8Reference control customization
				{
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param8Reference")
					.setCustomFieldCaption("Param 8");
					InfoCustomizations.getFieldCustomization(infoCustomizations, TestOp.Builder.class.getName(), "param8Reference")
					.setFormControlEmbeddingForced(true);
				}
				// hide UI customization method
				InfoCustomizations.getMethodCustomization(infoCustomizations, TestOp.Builder.class.getName(), ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(InfoCustomizations.class.getName())))
				.setHidden(true);
			}
		}
	...
	static public class Param6Structure{
		...
		static public class GroupBuilder implements OperationStructureBuilder<Param6Structure>{
			...
			@Override
			public Param6Structure build(Plan.ExecutionContext context, Plan.ExecutionInspector executionInspector) throws Exception {
		...
		static public class Param6StructureSubParam4Structure{
			...
			static public class GroupBuilder implements OperationStructureBuilder<Param6StructureSubParam4Structure>{
				...
				@Override
				public Param6StructureSubParam4Structure build(Plan.ExecutionContext context, Plan.ExecutionInspector executionInspector) throws Exception {
