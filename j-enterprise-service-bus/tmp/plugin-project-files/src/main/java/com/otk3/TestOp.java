...
public class TestOp implements com.otk.jesb.operation.Operation {
	...
	static public class Builder implements com.otk.jesb.operation.OperationBuilder<TestOp> {
		...
		public static InfoCustomizations getInfoCustomizations() {
			InfoCustomizations result = new InfoCustomizations();
			// TestOp.Builder form customization
			{
				// field control positions
				InfoCustomizations.getTypeCustomization(result, TestOp.Builder.class.getName())
						.setCustomFieldsOrder(Arrays.asList("param2", "param3Variant"));
				// param2 control customization
				{
					InfoCustomizations.getFieldCustomization(result, TestOp.Builder.class.getName(), "param2")
							.setCustomFieldCaption("bla bla bla");
					InfoCustomizations.getFieldCustomization(result, TestOp.Builder.class.getName(), "param2")
				...
				{
					InfoCustomizations
							.getFieldCustomization(result,
									VariantCustomizations.getAdapterTypeName(TestOp.Builder.class.getName(),
											"param3Variant"),
									VariantCustomizations.getConstantValueFieldName("param3Variant"))
							.setNullValueDistinctForced(true);
				...
				{
					InfoCustomizations
							.getFieldCustomization(result, TestOp.Builder.class.getName(), "param6GroupBuilder")
							.setNullValueDistinctForced(true);
					// Param6Structure.GroupBuilder form customization
					{
						// field control positions
						InfoCustomizations.getTypeCustomization(result, Param6Structure.GroupBuilder.class.getName())
								.setCustomFieldsOrder(Arrays.asList("subParam1", "subParam2"));
						// subParam1 control customization
						{
							InfoCustomizations.getFieldCustomization(result,
						...
						// hide 'build(...)' method
						InfoCustomizations.getMethodCustomization(result, TestOp.Param6Structure.class.getName(),
								ReflectionUIUtils.buildMethodSignature(Param6Structure.class.getName(), "build", Arrays
										.asList(ExecutionContext.class.getName(), ExecutionInspector.class.getName())))
								.setHidden(true);
						// hide 'validate(...)' method
						InfoCustomizations.getMethodCustomization(result, TestOp.Param6Structure.class.getName(),
								ReflectionUIUtils.buildMethodSignature(Param6Structure.class.getName(), "validate",
