		...
		public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
			/* com.otk3.TestOp.Builder form customization */
			{
				...
				xy.reflect.ui.info.custom.InfoCustomizations
						.getTypeCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName())
						.setCustomFieldsOrder(java.util.Arrays.asList("param2", "param3Variant", "param4DynamicBuilder",
								"param5DynamicBuilder", "param6GroupBuilder", "param7Variant", "param8Reference"));
				/* param2 control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
							com.otk3.TestOp.Builder.class.getName(), "param2").setCustomFieldCaption("Param 2");
					xy.reflect.ui.info.custom.InfoCustomizations
							.getTypeCustomization(
									xy.reflect.ui.info.custom.InfoCustomizations
											.getFieldCustomization(infoCustomizations,
													com.otk3.TestOp.Builder.class.getName(), "param2")
							...
							.setSpecificProperties(new java.util.HashMap<String, Object>() {
								private static final long serialVersionUID = 1L;
								{
									...
									xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginConfiguration(this,
											"xy.reflect.ui.control.swing.plugin.StyledTextPlugin",
											(java.io.Serializable) com.otk.jesb.util.MiscUtils.deserialize(
							...
							.setSpecificProperties(new java.util.HashMap<String, Object>() {
								private static final long serialVersionUID = 1L;
								{
									...
									xy.reflect.ui.util.ReflectionUIUtils.setFieldControlPluginConfiguration(this,
											"xy.reflect.ui.control.swing.plugin.SliderPlugin",
											(java.io.Serializable) com.otk.jesb.util.MiscUtils.deserialize(
													"<xy.reflect.ui.control.swing.plugin.SliderPlugin_-SliderConfiguration/>"));
								}
							});
				}
				...
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
							com.otk3.TestOp.Builder.class.getName(), "param4DynamicBuilder")
				...
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
							com.otk3.TestOp.Builder.class.getName(), "param5DynamicBuilder")
				...
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
							com.otk3.TestOp.Builder.class.getName(), "param6GroupBuilder")
				...
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
							com.otk3.TestOp.Builder.class.getName(), "param7Variant").setCustomFieldCaption("Param 7");
				}
				/* param8Reference control customization */
				{
					xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
							com.otk3.TestOp.Builder.class.getName(), "param8Reference")
				...
				xy.reflect.ui.info.custom.InfoCustomizations
						.getMethodCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(),
				...
				xy.reflect.ui.info.custom.InfoCustomizations
						.getMethodCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(),
								xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature(
										com.otk3.TestOp.class.getName(), "build",
										java.util.Arrays.asList(
												com.otk.jesb.solution.Plan.ExecutionContext.class.getName(),
												com.otk.jesb.solution.Plan.ExecutionInspector.class.getName())))
						.setHidden(true);
			}
		}
			...
			public static void customizeUI(xy.reflect.ui.info.custom.InfoCustomizations infoCustomizations) {
				/* Param6Structure.GroupBuilder form customization */
				{
					...
					xy.reflect.ui.info.custom.InfoCustomizations
							...
							.setCustomFieldsOrder(java.util.Arrays.asList("subParam1", "subParam2Variant",
									"subParam3DynamicBuilder", "subParam4GroupBuilder"));
					...
					{
						xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations,
								Param6Structure.GroupBuilder.class.getName(), "subParam2Variant")
					...
					xy.reflect.ui.info.custom.InfoCustomizations
							.getMethodCustomization(infoCustomizations, Param6Structure.GroupBuilder.class.getName(),
									xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature(
											Param6Structure.class.getName(), "build",
											java.util.Arrays.asList(
													com.otk.jesb.solution.Plan.ExecutionContext.class.getName(),
													com.otk.jesb.solution.Plan.ExecutionInspector.class.getName())))
							.setHidden(true);
					...
					/* Param6StructureSubParam4Structure.GroupBuilder form customization */
					{
						...
						xy.reflect.ui.info.custom.InfoCustomizations
								.getMethodCustomization(infoCustomizations,
										Param6StructureSubParam4Structure.GroupBuilder.class.getName(),
										xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature(
												Param6StructureSubParam4Structure.class.getName(), "build",
												java.util.Arrays.asList(
														com.otk.jesb.solution.Plan.ExecutionContext.class.getName(),
														com.otk.jesb.solution.Plan.ExecutionInspector.class.getName())))
								.setHidden(true);
