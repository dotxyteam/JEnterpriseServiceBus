...
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, com.otk3.Schedule.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("moment", "repeating", "repetitionSettings", "reference"));
/* moment control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), "moment").setCustomFieldCaption("moment");
}
/* repeating control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), "repeating").setCustomFieldCaption("Repeat");
}
/* repetitionSettings control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), "repetitionSettings").setCustomFieldCaption("Repetition Settings");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), "repetitionSettings").setFormControlEmbeddingForced(true);
RepetitionSettingsStructure.customizeUI(infoCustomizations);
}
/* reference control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), "reference").setCustomFieldCaption("Referennce");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), "referenceReference").setFormControlEmbeddingForced(true);
}
/* hide UI customization method */
xy.reflect.ui.info.custom.InfoCustomizations.getMethodCustomization(infoCustomizations, com.otk3.Schedule.class.getName(), xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName()))).setHidden(true);
}
}
@Override
