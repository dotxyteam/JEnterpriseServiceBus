...
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName()).setCustomFieldsOrder(java.util.Arrays.asList("param2", "param3", "param4", "param5", "param6", "param7", "param8"));
/* param2 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param2").setCustomFieldCaption("Param 2");
xy.reflect.ui.info.custom.InfoCustomizations.getTypeCustomization(xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param2").getSpecificTypeCustomizations(), java.lang.String.class.getName()).setSpecificProperties(new java.util.HashMap<String, Object>() {
...
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param4").setCustomFieldCaption("Param 4");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param4DynamicBuilder").setFormControlEmbeddingForced(true);
}
/* param5 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param5").setCustomFieldCaption("Param 5");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param5DynamicBuilder").setFormControlEmbeddingForced(true);
}
/* param6 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param6").setCustomFieldCaption("Param 6");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param6GroupBuilder").setNullValueDistinctForced(true);
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param6GroupBuilder").setFormControlEmbeddingForced(true);
Param6Structure.GroupBuilder.customizeUI(infoCustomizations);
}
/* param7 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param7").setCustomFieldCaption("Param 7");
}
/* param8 control customization */
{
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param8").setCustomFieldCaption("Param 8");
xy.reflect.ui.info.custom.InfoCustomizations.getFieldCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), "param8Reference").setFormControlEmbeddingForced(true);
}
/* hide UI customization method */
xy.reflect.ui.info.custom.InfoCustomizations.getMethodCustomization(infoCustomizations, com.otk3.TestOp.Builder.class.getName(), xy.reflect.ui.util.ReflectionUIUtils.buildMethodSignature("void", "customizeUI", java.util.Arrays.asList(xy.reflect.ui.info.custom.InfoCustomizations.class.getName()))).setHidden(true);
}
}
