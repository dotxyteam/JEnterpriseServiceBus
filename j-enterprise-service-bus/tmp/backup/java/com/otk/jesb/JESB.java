...
public class JESB {
	...
	public static void main(String[] args) throws Exception {
		...
		c.getDriverClassNameTemplate().setValue("org.hsqldb.jdbcDriver");
		c.getUrlTemplate().setValue("jdbc:hsqldb:file:/tmp/db;shutdown=true;hsqldb.write_delay=false;");
		...
		ab1.getStatementTemplate().setValue("SELECT * FROM INFORMATION_SCHEMA.SYSTEM_TABLES");
