 ...
 * 
 */
@WebServiceClient(name = "Hello_Service", targetNamespace = "http://www.examples.com/wsdl/HelloService.wsdl", wsdlLocation = "file:/media/olitank/data/prog/git/JEnterpriseServiceBus/j-enterprise-service-bus/unpackaged-src/com/otk/jesb/HelloService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/media/olitank/data/prog/git/JEnterpriseServiceBus/j-enterprise-service-bus/unpackaged-src/com/otk/jesb/HelloService.wsdl");
