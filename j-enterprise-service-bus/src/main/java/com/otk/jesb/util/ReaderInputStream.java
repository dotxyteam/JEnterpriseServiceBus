...
/**
 * (Copy of org.apache.commons.io.input.ReaderInputStream)
 * 
 ...
 * appear is when implementing the {@code javax.activation.DataSource} interface
...
public class ReaderInputStream extends InputStream {
	 ...
	 * encoding with a default input buffer size of {@value #DEFAULT_BUFFER_SIZE}
	 * characters.
	 *
	 * @param reader the target {@link Reader}
	 ...
	 * @return the number of bytes read or {@code -1} if the end of the stream has
	 *         been reached
	 * @throws IOException if an I/O error occurs.
	 */
	@Override
	 ...
	 * Read a single byte.
	 *
	 * @return either the byte read or {@code -1} if the end of the stream has been
	 *         reached
	 * @throws IOException if an I/O error occurs.
	 */
	@Override
