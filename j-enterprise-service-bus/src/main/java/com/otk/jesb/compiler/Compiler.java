...
public class Compiler {
	...
	/**
	 * Setting the parent class loader for the {@see ByteClassLoader} used to load
	 * the compiled byte code. This is needed when there are different class loaders
	 * in the application and the code compiling the class uses different class
	 * loader than the code wanting to use the compiled class. If no class loader is
	 * specified via this setter then the actual class loader will be used, which
